...
namespace RpgMvc.Controllers
{
    ...
    {
        public string uriBase = "http://leomiguel.somee.com/RpgApi/Disputas/";
        ...
        public async Task<ActionResult> IndexAsync()
        {
            try
            {
                ...
                string uriBuscaPersonagens = "http://leomiguel.somee.com/RpgApi/Personagens/GetAll";
        ...
        public async Task<ActionResult> IndexHabilidadesAsync()
        {
            try
            {
                ...
                string uriBuscaHabilidades = "http://leomiguel.somee.com/RpgApi/PersonagemHabilidades/GetHabilidades";
        ...
        [HttpGet]
        public async Task<IActionResult> DisputaGeralAsync()
        {
            try
            {
                HttpClient httpClient = new HttpClient();
                ...
                string uriDisputa = "http://leomiguel.somee.com/RpgApi/Disputas/DisputaEmGrupo";
